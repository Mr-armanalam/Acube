        ...
        <div className="video-controls-container">
          ...
          <div className="controls">
            <button onClick={handlePlay} className="play-pause-btn">
              {isPlaying ? (
                <svg class="pause-icon volicon" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
                ...
                <svg class="play-icon volicon" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
            ...
            <div className="volume-container">
              <button onClick={toggleMute} className="mute-btn">
                <svg class="volume-high-icon volicon" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
                    d="M14,3.23V5.29C16.89,6.15 19,8.83 19,12C19,15.17 16.89,17.84 14,18.7V20.77C18,19.86 21,16.28 21,12C21,7.72 18,4.14 14,3.23M16.5,12C16.5,10.23 15.5,8.71 14,7.97V16C15.5,15.29 16.5,13.76 16.5,12M3,9V15H7L12,20V4L7,9H3Z"
                  />
                </svg>
                <svg class="volume-low-icon volicon" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
                    d="M5,9V15H9L14,20V4L9,9M18.5,12C18.5,10.23 17.5,8.71 16,7.97V16C17.5,15.29 18.5,13.76 18.5,12Z"
                  />
                </svg>
                <svg class="volume-muted-icon volicon" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
